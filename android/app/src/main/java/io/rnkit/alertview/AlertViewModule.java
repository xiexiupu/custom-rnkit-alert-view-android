...
public class AlertViewModule extends ReactContextBaseJavaModule implements Application.ActivityLifecycleCallbacks, OnItemClickListener, OnDismissListener {
    private static final String TAG = AlertViewModule.class.getSimpleName();
    ...
    /* package */ static final String DONEBUTTONKEY = "doneButtonKey";
    ...
    public void alertWithArgs(@Nullable final ReadableMap options, @Nullable final Callback callback) {
        ...
        UiThreadUtil.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Log.d(TAG, "run: " + options.toString());
                ...
                final ArrayList<String> defaultButtons = new ArrayList<>();
...
//                            sendEvent(reactContext, "AlertViewEvent", map);
    ...
    private Bundle createFragmentArguments(ReadableMap options) {
        ...
        if (options.hasKey(DONEBUTTONKEY) && !options.isNull(DONEBUTTONKEY)) {
            args.putInt(DONEBUTTONKEY, options.getInt(DONEBUTTONKEY));
        }
