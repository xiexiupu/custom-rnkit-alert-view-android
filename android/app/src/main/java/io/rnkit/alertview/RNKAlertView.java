...
/**
 * Created by SimMan on 2016/12/5.
 */

public class RNKAlertView {
    public enum Style {
        ActionSheet,
        Alert
    }
    ...
    private com.bigkoo.alertview.AlertView.Style style = com.bigkoo.alertview.AlertView.Style.Alert;
    ...
    public RNKAlertView(RNKAlertView.Builder builder) {
    ...
    public RNKAlertView(String title, String msg, String cancel, String[] destructive, String[] others, Context context, com.bigkoo.alertview.AlertView.Style style, OnItemClickListener onItemClickListener) {
    ...
    protected void initData(String title, String msg, String cancel, String[] destructive, String[] others) {
        ...
        if (cancel != null) {
            this.cancel = cancel;
            if (style == com.bigkoo.alertview.AlertView.Style.Alert && mDatas.size() < HORIZONTAL_BUTTONS_MAXCOUNT) {
    ...
    protected void initListView() {
        ...
        //把cancel作为footerView
        if (cancel != null && style == com.bigkoo.alertview.AlertView.Style.Alert) {
            ...
            tvAlert.setOnClickListener(new RNKAlertView.OnTextClickListener(CANCELPOSITION));
        ...
        alertButtonListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                if (onItemClickListener != null)
                    onItemClickListener.onItemClick(RNKAlertView.this, position);
                // TODO: 2019/8/7 xiexiupu@live.com 取消 dismiss 由上层出发
//                dismiss();
            }
        });
    }
    ...
    protected void initActionSheetViews(LayoutInflater layoutInflater) {
        ...
        tvAlertCancel.setOnClickListener(new RNKAlertView.OnTextClickListener(CANCELPOSITION));
    }
    ...
    protected void initAlertViews(LayoutInflater layoutInflater) {
        ...
        if (mDatas.size() <= HORIZONTAL_BUTTONS_MAXCOUNT) {
            ...
            for (int i = 0; i < mDatas.size(); i++) {
                ...
                tvAlert.setOnClickListener(new RNKAlertView.OnTextClickListener(position));
                position++;
    ...
    public RNKAlertView addExtView(View extView) {
    ...
    public void dismiss() {
        ...
        View view = loAlertHeader.findViewById(R.id.etName);
    ...
    public Animation getInAnimation() {
        ...
        int res = RNKAlertAnimateUtil.getAnimationResource(this.gravity, true);
    ...
    public Animation getOutAnimation() {
        ...
        int res = RNKAlertAnimateUtil.getAnimationResource(this.gravity, false);
        return AnimationUtils.loadAnimation(context, res);
    }

    public RNKAlertView setOnDismissListener(OnDismissListener onDismissListener) {
...
//                dismiss();
    ...
    public RNKAlertView setCancelable(boolean isCancelable) {
    ...
    public static class Builder {
        ...
        private com.bigkoo.alertview.AlertView.Style style;
        private String title;
        private String msg;
        private String cancel;
        private String[] destructive;
        ...
        public RNKAlertView.Builder setContext(Context context) {
            this.context = context;
            return this;
        }

        public RNKAlertView.Builder setStyle(com.bigkoo.alertview.AlertView.Style style) {
            if (style != null) {
                this.style = style;
            }
            return this;
        ...
        public RNKAlertView.Builder setTitle(String title) {
            this.title = title;
            return this;
        }

        public RNKAlertView.Builder setMessage(String msg) {
            this.msg = msg;
            return this;
        }

        public RNKAlertView.Builder setCancelText(String cancel) {
            this.cancel = cancel;
            return this;
        }

        public RNKAlertView.Builder setDestructive(String... destructive) {
            this.destructive = destructive;
            return this;
        }

        public RNKAlertView.Builder setOthers(String[] others) {
            this.others = others;
            return this;
        }

        public RNKAlertView.Builder setOnItemClickListener(OnItemClickListener onItemClickListener) {
            this.onItemClickListener = onItemClickListener;
            return this;
        }

        public RNKAlertView build() {
            return new RNKAlertView(this);
        }
    }
}
